    ...
    >
      <Grid item  xs={12} sm={12} md={4} lg={4} xl={4}>
            <Box className='PricingBox'>
              ...
              <Button className='CommonButton EditBtn' variant="contained">EDIT</Button>
              </Box>
              <Box className='PricingContentBox'>
                <ul>
                  <li>
                    <Box className='ProductInfo'>
                  <Typography variant="h6" textAlign="left">Model: 1875, non-convection</Typography>
                  </Box>
                  <Box className='ProductAmount'>
                  <Typography variant="h6" textAlign="right">$ 8295</Typography>
                  </Box>
                  </li>
                  <li>
                    <Box className='ProductInfo'>
                  <Typography variant="h6" textAlign="left">Model Description</Typography>
                  <Typography variant="body2" textAlign="left">45” Six-Burner Dual Feul</Typography>
                  <Typography variant="body2" textAlign="left">Self-Cleaning</Typography>
                  ...
                  <li>
                    <Box className='ProductInfo'>
                  <Typography variant="h6" textAlign="left">Colour</Typography>
                  <Typography variant="body2" textAlign="left">Black</Typography>
                  </Box>
                  <Box className='ProductAmount'>
                  <Typography variant="h6" textAlign="right"></Typography>
                  </Box>
                  ...
                  <li>
                    <Box className='ProductInfo'>
                  <Typography variant="h6" textAlign="left">Gas Type</Typography>
                  <Typography variant="body2" textAlign="left">Natural Gas</Typography>
                  </Box>
                  <Box className='ProductAmount'>
                  <Typography variant="h6" textAlign="right"></Typography>
                  </Box>
                  ...
                  <li>
                    <Box className='ProductInfo'>
                  <Typography variant="h6" textAlign="left">Metal Trim</Typography>
                  <Typography variant="body2" textAlign="left">Nickel</Typography>
                  </Box>
                  <Box className='ProductAmount'>
                  <Typography variant="h6" textAlign="right"></Typography>
                  </Box>
                  ...
                  <li>
                    <Box className='ProductInfo'>
                  <Typography variant="h6" textAlign="left">Door Frames</Typography>
                  <Typography variant="body2" textAlign="left">Nickel</Typography>
                  </Box>
                  <Box className='ProductAmount'>
                  <Typography variant="h6" textAlign="right">$ 350</Typography>
                  </Box>
                  </li>
                  <li>
                    <Box className='ProductInfo'>
                  <Typography variant="h6" textAlign="left">Legs Trim</Typography>
                  <Typography variant="body2" textAlign="left">Nickel</Typography>
                  </Box>
                  <Box className='ProductAmount'>
                  <Typography variant="h6" textAlign="right">$ 200</Typography>
                  </Box>
                  </li>
                  <li>
                    <Box className='ProductInfo'>
                  <Typography variant="h6" textAlign="left">Front Skirt</Typography>
                  <Typography variant="body2" textAlign="left">Nickel</Typography>
                  </Box>
                  <Box className='ProductAmount'>
                  <Typography variant="h6" textAlign="right">$ 200</Typography>
                  ...
                  <li>
                    <Box className='ProductInfo'>
                  <Typography variant="h6" textAlign="left">Trivet</Typography>
                  <Typography variant="body2" textAlign="left">Nickel</Typography>
                  </Box>
                  <Box className='ProductAmount'>
                  <Typography variant="h6" textAlign="right">$ 200</Typography>
                  ...
                  <li>
                    <Box className='ProductInfo'>
                  <Typography variant="h6" textAlign="left">Decorative Shelf</Typography>
                  <Typography variant="body2" textAlign="left">Nickel</Typography>
                  </Box>
                  <Box className='ProductAmount'>
                  <Typography variant="h6" textAlign="right">$ 100</Typography>
                  </Box>
                  </li>
                  <li>
                    <Box className='ProductInfo'>
                  <Typography variant="h6" textAlign="left">Ventilation</Typography>
                  <Typography variant="body2" textAlign="left">Nickel</Typography>
                  </Box>
                  <Box className='ProductAmount'>
                  <Typography variant="h6" textAlign="right"></Typography>
                  ...
                  <li>
                    <Box className='ProductInfo'>
                  <Typography variant="h6" textAlign="left">Antiquing</Typography>
                  </Box>
                  <Box className='ProductAmount'>
                  <Typography variant="h6" textAlign="right">$ 200</Typography>
                  </Box>
              ...
              <Typography variant="h5" textAlign="right"><span>TOTAL</span>$ 9345</Typography>
              </Box>
              </Box>            
      </Grid>
      <Grid item  xs={12} sm={12} md={4} lg={4} xl={4}>
      <Box className='PricingBox'>
              ...
              <Button className='CommonButton AddBtn' variant="contained">ADD</Button>
              </Box>
              <Box className='PricingContentBox'>
                <ul>
                  <li>
                    <Box className='ProductInfo'>
                  <Typography variant="h6" textAlign="left">Model: <span className='RedColor'>Not Selected</span></Typography>
                  </Box>
                  <Box className='ProductAmount'>
                  <Typography variant="h6" textAlign="right">$ -</Typography>
                  </Box>
                  ...
                  <li>
                    <Box className='ProductInfo'>
                  <Typography variant="h6" textAlign="left">Handles</Typography>
                  <Typography variant="body2" textAlign="left">-</Typography>
                  </Box>
                  <Box className='ProductAmount'>
                  <Typography variant="h6" textAlign="right"></Typography>
                  ...
                  <li>
                    <Box className='ProductInfo'>
                  <Typography variant="h6" textAlign="left">Hinge</Typography>
                  <Typography variant="body2" textAlign="left">-</Typography>
                  </Box>
                  <Box className='ProductAmount'>
                  <Typography variant="h6" textAlign="right"></Typography>
                  ...
                  <li>
                    <Box className='ProductInfo'>
                  <Typography variant="h6" textAlign="left">Ice Maker</Typography>
                  <Typography variant="body2" textAlign="left">-</Typography>
                  </Box>
                  <Box className='ProductAmount'>
                  <Typography variant="h6" textAlign="right"></Typography>
              ...
              <Typography variant="h5" textAlign="right"><span>TOTAL</span>$ -</Typography>
              </Box>
              </Box>
      </Grid>
      <Grid item  xs={12} sm={12} md={4} lg={4} xl={4}>
      <Box className='PricingBox'>
              ...
              <Box className='PricingContentBox'>
                <ul>
                  ...
                  <li>
                    <Box className='ProductInfo'>
                  <Typography variant="h6" textAlign="left">Metal Trim Color</Typography>
                  <Typography variant="body2" textAlign="left">-</Typography>
                  </Box>
                  <Box className='ProductAmount'>
                  <Typography variant="h6" textAlign="right"></Typography>
